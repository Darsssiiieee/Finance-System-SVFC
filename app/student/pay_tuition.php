      ...
      <div class="modal-action">
        <form class="w-full flex flex-col gap-5" method="post">
          ...
          <label class="form-control w-full">
            ...
            <input value="<?php echo $bill_amount ?>" type="text" disabled class="input input-bordered w-full" />
          </label>
          ...
          <label class="form-control w-full">
            ...
            <input name="amount_to_be_paid" type="text" class="input input-bordered w-full" />
          </label>
          ...
          <div>
            ...
            $payment_methods = [
              ...
              [
                ...
                <path stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="12" d="M161.549 58.776C166.965 70.04 170 82.666 170 96c0 13.334-3.035 25.96-8.451 37.223"/>
              </svg>'
              ]
            ];
            ...
            ?>
              <div class="form-control">
                <label class="label cursor-pointer">
                  ...
                  <input type="radio" name="<? echo $payment_method['name'] ?>" class="radio checked:bg-red-500" checked />
                </label>
              </div>
            <?php
            }
