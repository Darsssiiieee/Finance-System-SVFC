  ...
  <dialog id="logout_modal" class="modal backdrop-blur">
    <div class="modal-box">
      ...
      <div class="modal-action">
        <a href="../utils/logout.php" class="menuButton btn btn-yes btn-error text-white font-bold" onclick="logout()">YES</a>
        <button class="menuButton btn btn-cancel" onclick="logout_modal.close()">CANCEL</button>
      </div>
    </div>
  </dialog>
    ...
    <div class="navbar-start w-auto lg:hidden">
      <div class="dropdown">
        ...
        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
          ...
          <li>
            <button onclick="logout_modal.showModal()" class="link-error link no-underline">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4">
  ...
  <main class="w-11/12 xl:w-10/12 h-full flex mt-10 flex-row justify-center gap-5">
    <aside class="min-h-screen w-1/4 hidden lg:block">
      <ul tabindex="0" class="menu rounded-lg justify-center border border-slate-900/10 flex flex-col bg-base-100 shadow-xl rounded-xl min-h-96 justify-evenly mt-3 z-[1] p-3">
        ...
        <li>
          <button class="btn btn-error text-white" onclick="logout_modal.showModal()">LOGOUT</button>
        </li>
      </ul>
    </aside>

    <section class="flex flex-col w-11/12 justify-center items-center lg:items-start lg:grid lg:grid-cols-1 lg:gap-2">
      ...
      <div class="collapse collapse-arrow bg-base-200">
        ...
        <div class="collapse-content">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia corporis officiis autem ex porro dignissimos atque aliquam voluptatum dolores, expedita commodi! Facilis earum fuga sapiente, maiores necessitatibus corporis incidunt nam similique quos sit soluta, praesentium mollitia tempore aspernatur iure eos? Aspernatur nostrum impedit placeat blanditiis fugiat obcaecati odio quae nihil.</p>
        </div>
      </div>
      <div class="collapse collapse-arrow bg-base-200">
        <input type="radio" name="my-accordion-2" checked="checked" />
